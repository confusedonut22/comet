...
def can_split_hand(hand: HandState, allow_same_value_split: bool = False) -> bool:
...
def split_hand(state: RoundState, hand_index: int, shoe: Shoe, allow_same_value_split: bool = False) -> Tuple[bool, List[HandState]]:
